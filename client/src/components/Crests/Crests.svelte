...
<div class="flexbox_crest">
    <div>
        ...
        <img
            width="200px"
            src={path + "Gryffindor.png"}
            alt="Gryffindor creast"
        />
    </div>
    <p>
...
<div class="flexbox_crest">
    <div>
        ...
        <img
            width="200px"
            src={path + "Ravenclaw.png"}
            alt="Ravenclaw creast"
        />
    </div>
    <p>
...
<div class="flexbox_crest">
    <div>
        ...
        <img
            width="200px"
            src={path + "Hufflepuff.png"}
            alt="Hufflepuff creast"
        />
    </div>
    <p>
...
<div class="flexbox_crest">
    <div>
        ...
        <img
            width="200px"
            src={path + "Slytherin.png"}
            alt="Slytherin creast"
        />
    </div>
    <p>
